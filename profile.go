// Code generated by importing it from the Go tools repository. DO NOT EDIT.
// https://cs.opensource.google/go/x/tools/+/refs/tags/v0.35.0:cover/profile.go
...
func ParseProfiles(fileName string, ignore *Ignore) ([]*Profile, error) {
	pf, err := os.Open(fileName)
	if err != nil {
		return nil, err
	}
	defer pf.Close()
	return ParseProfilesFromReader(pf, ignore)
}

// ParseProfilesFromReader parses profile data from the Reader and
// returns a Profile for each source file described therein.
func ParseProfilesFromReader(rd io.Reader, ignore *Ignore) ([]*Profile, error) {
